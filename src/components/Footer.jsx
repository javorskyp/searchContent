...
const Footer = () => {
    return (
    <div className='footer p-[5rem] mb-4 bg-blueColor roundedd-[10px] gap-[8] grid grid-cols-5 m-auto items-center justify-center'>
        <div>
            <div className='logo'>
            ...
            <p className='text-white pb-[13px] opacity-70 leading-7'>
                Lorem, ipsum dolor sit amet consectetur adipisicing elit. Eiussss porro doloribus sint maxime soluta quas.
            </p>
        </div>
        <div className='grid'>
        ...
        <div className='grid'>
            ...
            <li className='text-white opacity-[.7] hover:opacity-[1]'>Docs</li>
